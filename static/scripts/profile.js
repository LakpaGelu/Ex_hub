...
const skill = document.getElementsByClassName("nav-btns")[3];
...
const skillEl = document.getElementsByClassName("content")[3];
...
bio.addEventListener("click", e => {
    ...
    skill.classList.remove("active-right");
...
skill.addEventListener("click", e => {
    ...
    education.classList.remove("active-right");
    experience.classList.remove("active-right");
    skill.classList.add("active-right");

    education.firstElementChild.classList.remove("design");
    experience.firstElementChild.classList.remove("design");
    skill.firstElementChild.classList.add("design");
